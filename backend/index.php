<?php include("header.php"); ?>
    ...
    <section class="home-bill">
        <header>BILL OF THE DAY</header>
        <article>
            <h4>H.R. 4315: 21st Century Endangered Species Transparency Act</h4>
            ...
            <div class="post-info">
                <div class="timestamp">11:30pm 01/07/2013</div>
