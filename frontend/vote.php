...
$limit = 5;
$sql = mysqli_query($db_conx, "SELECT * FROM bills ORDER BY id DESC LIMIT 5");
...
<div class="bodyWrap">
	<section class="votePage">
		...
		<?php 
			...
			while($x<=4) {
				$voteBillConvert = str_replace("html", "json", $result[$x]["local_html"]);
	        ...
	        <div class="billTitle">
	            <h4>'.strtoupper($result[$x]["code"]).'</br>
	            '.$result[$x]["title"].'</h4>
