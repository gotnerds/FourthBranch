            ...
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown"><a href="#"><span class="iconfa-envelope"></span>Bill</a>
                    <ul>
                        ...
                        <li><a href="supp.bill.php">Support Cause</a></li>
	
                       <li class="dropdown"><a href="#">Add New</a>
		
                        <ul>
                            <li><a href="add.bill.php?name=Regular">Regular Bill</a></li>
                            <li><a href="add.bill.php?name=Big">Big Bill</a></li>
<li><a href="add.bill.php?name=Appropriations">Appropriations Bill</a></li>
                ...
                <li><a href="comment.php"><span class="iconfa-calendar"></span> Reported Comments</a></li>
                 <li><a href="about.php"><span class="iconfa-calendar"></span> About</a></li>
                
 <li><a href="contact.php"><span class="iconfa-calendar"></span> Contact</a></li>
                

<li class="dropdown"><a href="#"><span class="iconfa-th-list"></span>News</a>

                	<ul>
                    	 <li><a href="view.news.php">All News</a></li>
...
<li class="dropdown"><a href="#"><span class="iconfa-th-list"></span>Proposal</a>
                	...
                	<ul>
                    	<li><a href="add.vdo.php">Content</a></li>
                            <li><a href="view.proposal.php">Users Proposal</a></li>
                    </ul>
                </li>
                
<li><a href="wow.php"><span class="iconfa-calendar"></span>Wall of America</a></li>
