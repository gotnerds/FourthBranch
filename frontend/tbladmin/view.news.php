...
if( isset($_GET['status']) && (!empty($_GET['status'])) ){
	...
	$u_sql="delete from news where id = ". $_GET['id'];
	$u_query=mysqli_query($con,$u_sql);	
	if($u_query){
		$msg =  'News deleted successfully.';
	}else{
		$msg =  'Sorry no News existed.';	
	}
                ...
                <div class="row-fluid">
                    <div id="dashboard">
                        ...
                        <div class="widgetcontent nopadding">
                          <?php if(!empty($msg)){echo '<div style="padding:10px">'.$msg.'</div>';}?>
                        </div>
                        <div class="row-fluid">
                        			...
                        			<th> Action </th>
										...
										$cnt = 0;
                        					...
                        					echo "<tr>
                        						...
                        						<td>
                                                    <a href='view.news.php?id=$id&status=delete' >Delete</a>
                                                </td>
