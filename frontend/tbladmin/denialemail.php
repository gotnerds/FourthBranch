...
if(mail($email,"Admin",$txt,"From : as@gmail.com"))
    echo "<script> alert('Denial Email Sent !');</script>";
            ...
            <div class="maincontentinner">
                <div class="row-fluid">
                    <div id="dashboard">
                        ...
                        <h4 class="widgettitle"><span class="icon-comment icon-white"></span>Comments</h4>
...
<center><form method="post" action="">
                        		...
                        		<tr>
                        			...
                        			<tr>
                                  <b>  Enter Reason To Disapprove<b>
                                    ...
                                    <tr>
                                    <center><input type="submit" value="Send" name="sbt" class="btn btn-info alertinfo"></center>
