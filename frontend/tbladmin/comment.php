...
$sql="SELECT * FROM `comment` where `reportStatus` = '0'";
                        			...
                        			<th> Status </th>
                        				...
                        				<?php
                        					while($res=mysqli_fetch_assoc($query)){
                        						...
                        						$submitdate=$res['dateSubmitted'];
                        						$user=$res['reportedUser'];
                        						$bill=$res['relevantBill'];
                                                $st=$res['reportStatus'];
                                                if($st=="0"){
                                                    $status="Active";
                                                }
                        					...
                        					echo "<tr>
                        						...
                        						<td>
                        							...
                        							<td>
                        							<a href='comment.php?id=$id&status=$status' >$status</a>
                        						</td>
