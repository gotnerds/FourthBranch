...
$sql="insert into bill(billType,proposalcategory1,proposalcategory2,proposalcategory3,title,dateIssued,submittedBy,status,content,summarySubmittedBY,billcode,hyperlinck,supportcause) values('$billtype', '$proposal1', '$proposal2', '$proposal3', '$title', NOW(), '$submitted', '$status', '$content', '$summarysubmittedby', '$billcode', '$hyperlink',0)";
        ...
        <div class="maincontent">
            <div class="maincontentinner">
               ...
               <form action="" method="post">
                    ...
                    <td>
                         <input type="text" name="proposal1" class="input-medium" >
                    ...
                    <td>
                        <input type="text" name="proposal2" class="input-medium" >
                    ...
                    <td>
                         <input type="text" name="proposal3" class="input-medium" >
                    ...
                    <td>
                         <input type="text" name="submitted" class="input-medium" >
...
<textarea name="content" rows=10 cols=25 >
                    ...
                    <td>
                       <input type="text" name="summarysubmit" class="input-medium" >
  ...
  <input type="text" name="billcode" class="input-medium" >
                    ...
                    <td>
                         <input type="text" name="hyperlink" class="input-medium" >
