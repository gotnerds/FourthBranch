...
if($supp==1){
    ...
    $sql1="update bill set Supportcause=0 where id=$id";
    $query1=mysqli_query($con,$sql1);

}

$sql="select * from bill  where Supportcause=1 order by id desc";
            ...
            <div class="maincontentinner">
                <div class="row-fluid">
                    <div id="dashboard">
                        ...
                        <h4 class="widgettitle"><span class="icon-comment icon-white"></span>Support Cause Area</h4>
                        				...
                        				<?php
                        					...
                        					echo "<tr>
                        						...
                        						<td>
                                                    ...
                                                    <td>
                                                    <a href='bill.php?sup=1&id=$id' >Support Cause</a>
                                                </td>
											 <td>
                                                    <a href='#' >BOD</a>
                                                </td>
