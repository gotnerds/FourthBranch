        ...
        <div class="maincontent">
            <div class="maincontentinner">
               ...
               <form action="" method="post" enctype= multipart/form-data>
                    ...
                    <tr>
                    <td style="font-weight:bold">News URL</td>
                    <td>
                        <input type="text" name="newurl" id="newurl" class="input-medium">
                    ...
                    <td>
                         <input type="file" name="photo1" class="input-medium" >
                    </td>
            ...
            <center><input type="submit" name="sbt" id="sbt" class="btn btn-info alertinfo" value="Add News"></center>

                    </td>
                    
                    </tr>
                    <tr>
                        <td colspan="3">Note : Upload Image Or Enter the Url of the Image</td>
                    </tr>
