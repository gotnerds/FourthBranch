...
<div class='overlay'>
	<div class='wrap-outer'>
		<div class='wrap' style="position:relative;float:left;">
								...
								<td>
									<div style='margin: 15px 15px 15px 15px'>
										...
										<form action="#" name="llLogin" id="llLogin" method="post">
											<input type='email' id="llEmail" name="lEmail" size='20' placeholder='Email' />
											<input type='password' size='20' id="llPassword" name="llPassword" placeholder='Password' />
										</form>
										<div style='overflow:hidden;'>
											...
											<script type="text/javascript" >
												function login1(){
														var lEmail = document.getElementById('llEmail').value;
														var lPassword = document.getElementById('llPassword').value;
														if((lEmail == '') || (lPassword == ''))
														{
														$("#llEmail").val("Incorrect Email or password");
														}
														else
														{
														var dataString = "lEmail="+lEmail+"&lPassword="+lPassword;							
			...
			<table cellpadding='2' bgcolor='#CC0000' id='introduction' style='position:fixed; top: 50%; left: 50%;margin-top:-90px;margin-left:-225px;'>
				<td>
					<table cellpadding='2' bgcolor='#2F68D1'>
						<td>
							<table cellpadding='2' bgcolor='#FFFFFF'>
									...
									<td width="580">
										<div style="margin: 15px 15px 15px 15px;">
											...
											<p align='center' >
												...
												Please activate your account now and become an active participant in your government.
											</p>
											<div style="float:right;overflow:hidden;">
												<button id='button' 
														  onclick='toggleOverlay_new();' 
